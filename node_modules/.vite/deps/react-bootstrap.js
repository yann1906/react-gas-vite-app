import {
  ...
  removeClass
} from "./chunk-SENP2NVY.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  init_extends,
  require_prop_types
} from "./chunk-Y2IGUPNF.js";
import {
  Button_default,
  Button_default2,
  Col_default,
...
var AccordionCollapse = React5.forwardRef(({
  as: Component2 = "div",
  bsPrefix,
  className,
  children,
  ...
  return (0, import_jsx_runtime3.jsx)(Collapse_default, {
    ...
    children: (0, import_jsx_runtime3.jsx)(Component2, {
      children: React5.Children.only(children)
    })
  });
});
...
var context2 = React6.createContext({
  eventKey: ""
});
...
var AccordionBody = React7.forwardRef(({
...
var AccordionButton = React8.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
...
var AccordionHeader = React9.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "h2",
  bsPrefix,
  className,
...
var Accordion = React11.forwardRef((props, ref) => {
  const {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    activeKey,
...
var divWithClassName_default = (className) => React12.forwardRef((p, ref) => (0, import_jsx_runtime9.jsx)("div", {
  ...p,
  ref,
...
var Alert = React18.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime15.jsx)(Transition, {
    unmountOnExit: true,
    ...props,
    ref: void 0,
    in: show,
...
function useUpdateEffect(fn, deps) {
  const isFirst = (0, import_react26.useRef)(true);
...
function map(children, func) {
  let index = 0;
  return React38.Children.map(children, (child) => React38.isValidElement(child) ? func(child, index++) : child);
}
...
function hasChildOfType(children, type) {
  return React38.Children.toArray(children).some((child) => React38.isValidElement(child) && child.type === type);
}
...
var Carousel = React39.forwardRef(({
  ...
  const nextDirectionRef = (0, import_react30.useRef)(null);
  const [direction, setDirection] = (0, import_react30.useState)("next");
  const [paused, setPaused] = (0, import_react30.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react30.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react30.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react30.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react30.useRef)();
  ...
  const handleEnter = (0, import_react30.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null ? void 0 : onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react30.useCallback)(() => {
    setIsSliding(false);
    onSlid == null ? void 0 : onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react30.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null ? void 0 : onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react30.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null ? void 0 : onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react30.useRef)(0);
  const touchDeltaXRef = (0, import_react30.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react30.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react30.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react30.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react30.useRef)();
  (0, import_react30.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react30.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
    ...
    children: [indicators && (0, import_jsx_runtime35.jsx)("div", {
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime35.jsx)(TransitionWrapper_default, {
          ...
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React39.cloneElement(child, {
            ...innerProps,
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react31.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react31.useState)(defaultValue);
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react31.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react32.useReducer)((state) => !state, false);
  return dispatch;
}
...
function useSafeState(state) {
  const isMounted = useMounted();
  return [state[0], (0, import_react33.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react37.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react37.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react37.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react37.useState)(true);
  ...
  return (0, import_react37.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react37.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react37.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react37.default).createElement((0, import_react37.default).Fragment, null, props.children);
  }
  return (0, import_react37.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react37.useContext)($b5e257d569688ac6$var$SSRContext);
  let ref = (0, import_react37.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react37.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react37.default).useId();
  let [didSSR] = (0, import_react37.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react37.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react37.default)["useSyncExternalStore"] === "function")
    return (0, import_react37.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react37.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
function NoopTransition({
  ...
  const child = (0, import_react58.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react59.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React85.forwardRef((_ref, ref) => {
  let {
...
var Modal = (0, import_react61.forwardRef)((_ref, ref) => {
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime83.jsx)("div", Object.assign({}, dialogProps, {
    children: React87.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime83.jsx)(import_jsx_runtime84.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime85.jsxs)(import_jsx_runtime84.Fragment, {
...
var ModalBody = React88.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React89.createContext({
...
var ModalDialog = React90.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React91.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React92.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var ModalHeader = React93.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React94.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React95.forwardRef(({
  ...
  const renderBackdrop = (0, import_react63.useCallback)((backdropProps) => (0, import_jsx_runtime93.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React96.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React97.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React98.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarBrand = React99.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React100.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React101.forwardRef(({
  bsPrefix,
  className,
  children,
...
var OffcanvasBody = React102.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React103.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime101.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React103.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React104.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React105.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React106.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react69.useCallback)((backdropProps) => (0, import_jsx_runtime104.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React107.forwardRef((props, ref) => {
...
var NavbarText = React108.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React109.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var NavDropdown = React110.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React111.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
...
var PopoverHeader = React112.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React113.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React115.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Tooltip = React116.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Overlay2 = React117.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime118.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React117.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React118.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime121.jsxs)(import_jsx_runtime120.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react76.cloneElement)(children, triggerProps), (0, import_jsx_runtime119.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React119.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React119.forwardRef(({
    children,
    ...props
...
var Pagination = React120.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime125.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames87.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime125.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React121.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React122.forwardRef(({
  ...
  return (0, import_jsx_runtime126.jsx)("div", {
    ...
    className: (0, import_classnames88.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React122.Children.only(children)
  });
});
...
var Row = React123.forwardRef(({
  ...
  return (0, import_jsx_runtime127.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames89.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React124.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
  ...
  return (0, import_jsx_runtime128.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames90.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React125.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime130.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime129.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime129.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
    disabled: props.disabled,
    childBsPrefix: bsPrefix,
    children: (0, import_jsx_runtime129.jsx)("span", {
      className: "visually-hidden",
      children: toggleLabel
    })
  }), (0, import_jsx_runtime129.jsx)(Dropdown_default2.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var Stack = React126.forwardRef(({
  ...
  return (0, import_jsx_runtime131.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames91.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
var TabPanel = React127.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime132.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime132.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime132.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime132.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime134.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React130.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React131.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime136.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime136.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime136.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime136.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames93.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Table = React132.forwardRef(({
  ...
  const classes = (0, import_classnames94.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime137.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime138.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime138.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime139.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime138.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime138.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime138.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React134.forwardRef((props, ref) => (0, import_jsx_runtime140.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React135.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React136.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  return (0, import_jsx_runtime142.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames95.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime141.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React137.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
  ...
  return (0, import_jsx_runtime143.jsx)(Component2, {
    ref,
    className: (0, import_classnames96.default)(className, bsPrefix),
    ...props
  });
});
...
var Toast = React138.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime144.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames97.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime144.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime144.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React139.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime145.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames98.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop6 = () => void 0;
var ToggleButton = React140.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime148.jsxs)(import_jsx_runtime147.Fragment, {
    children: [(0, import_jsx_runtime146.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime146.jsx)(Button_default2, {
      ...props,
      ref,
      className: (0, import_classnames99.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React141.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime149.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
